...
ใน Dashboard สามารถกด `เพิ่มหนี้`, `จ่ายงวด/รับคืน`, และ `ปิด/ยกเลิก` ได้จากการ์ดหนี้สินโดยตรง ถ้าติ๊ก “ลงเป็นรายการรายรับ/รายจ่ายในบัญชีด้วย” ระบบจะสร้าง transaction ให้พร้อมกัน
