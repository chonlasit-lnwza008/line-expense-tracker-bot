...
- ลบล่าสุด แก้ล่าสุด สรุปวันนี้ สรุปเดือนนี้ ตั้งงบ ตั้งเป้า และ export CSV/PDF
...
- Export รายงานเป็น CSV สำหรับ Excel หรือ PDF สำหรับส่งต่อ/เก็บเป็นรายงาน
...
กดพื้นที่ใหญ่ด้านบนของ Rich Menu เพื่อเปิด Dashboard ใน LINE ใช้ดูภาพรวม กราฟ กรองรายการตามประเภท/หมวด แก้ไขรายการ ตั้งงบ ตั้งเป้าเก็บเงิน และ Export รายงานได้โดยไม่ต้องพิมพ์คำสั่งยาว ๆ
